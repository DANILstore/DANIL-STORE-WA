exports.info = (id, Danil store, corohelp, tampilTanggal, tampilWaktu, instagram, telegram, youtube, kapanbotaktif, grupch1, grupch2) => {
	return `⚜ ${Danil store} ⚜
...
INFO BOT# :
🔱 *AUTHOR*: Danil store
🔱 *GITHUB*: https://github.com/DANILstore/DANIL-STORE_WA
🔱 *INSTAGRAM*: ${denil.ertanas}
🔱 *YOUTUBE*: ${Denil ertanas67}
🔱 *TELEGRAM* : ${danil}
🔱 *WHATSAPP* : 083124913691
...
bot aktif selama : ${DUA KALI 24JAM}
