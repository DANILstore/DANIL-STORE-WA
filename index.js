...
/////////////////
const BotName = Danil store; 
const instagram = 'https://instagram.com/denil.ertanas'; 
const telegram = 'https://t.me/reuzzz'; 
const kapanbotaktif = 'DUA KALI 24JAM; 
const youtube = 'https://youtube.com/channel/UC4ZehBVY0lsk173cyY7VXvw';
//const grupch1 = 'https://chat.whatsapp.com/DgBCxWsqR3j81XSL8517Gd; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@denil.ertanas')
